 ...
 ********************************************************************/
    ...
    /* STD_ID */
    CAN_0.BUF[0].ID.B.STD_ID = 0x501; /* engine coolant temperature message id */
    ...
    /* STD_ID */
    CAN_0.BUF[1].ID.B.STD_ID = 0x502; /* speed message id */
    ...
    /* STD_ID */
    CAN_0.BUF[2].ID.B.STD_ID = 0x503; /* headlight switches message id */
    ...
    /* STD_ID */
    CAN_0.BUF[3].ID.B.STD_ID = 0x504; /* alive message id */
    ...
    /* STD_ID */
    CAN_0.BUF[4].ID.B.STD_ID = 0x505; /* error message id */
    ...
    /* STD_ID */
    CAN_0.BUF[5].ID.B.STD_ID = 0x506; /* Change to the correct ID! */
